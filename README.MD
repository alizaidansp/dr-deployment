...
Note:  ECR Module behaves differently when using it with Jenkins, it doesnt require sudo cus the app is pulled automatically but sudo is required for local build
